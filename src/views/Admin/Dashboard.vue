...
<template>
  <div class="dashboard-page p-8">
    <h1 class="text-4xl font-bold text-gray-800 mb-6">📊 Bienvenue administrateur {{ user.prenom }} {{ user.name }}</h1>
    <p class="text-gray-500 mb-8">
      Voici un aperçu de votre espace d'administration. Utilisez la barre latérale pour naviguer.
    </p>
...
import api from '@/services/api' // service axios pour les stats
